...
- [coding-contest](https://github.com/brycewhit13/rust-miniprojects/tree/main/digital-clock): A CLI that gets current and upcoming coding competitions from different sites.
